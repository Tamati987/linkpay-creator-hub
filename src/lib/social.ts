...
const BRANDS: { test: (host: string, url: string) => boolean; brand: SocialBrand }[] = [
  ...
  { test: (h) => h.endsWith("twitter.com"), brand: { key: "twitter", label: "Twitter", Icon: SiTwitter, color: "#1DA1F2" } },
  ...
  { test: (h) => h.endsWith("linkedin.com"), brand: { key: "linkedin", label: "LinkedIn", Icon: SiLinkedin, color: "#0A66C2" } },
